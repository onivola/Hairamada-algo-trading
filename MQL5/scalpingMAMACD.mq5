...
void OnTick()
  {/*******************M1********************************/
     ...
     /* Get_Min_Max(MAX800H1,MIN800H1,800,PERIOD_H1,MODE_EMA);
      ...
      Get_Min_Max(MAX5M5,MIN5M5,1,PERIOD_M1,MODE_EMA);
      double ma800M5 = GetMovingAverage(1,PERIOD_M1,800,MODE_EMA);
      double RSI800M5= MovingAverageToRSI(ma800M5,MIN5M5,MAX5M5);
      Print(RSI800M5);
   ...
   if(posTotal>0 && (profit>=0.2 || profit<=-1)) {
      close(_Symbol);
   }
}
