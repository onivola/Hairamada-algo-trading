...
void OnTick()
  {/*******************M1********************************/
     ...
     /* Get_Min_Max(MAX800H1,MIN800H1,800,PERIOD_H1,MODE_EMA);
      ...
      printf("RSI800M1="+RSI800);
       printf("RSI200M1="+RSI200);
     int posTotal = getSymbolPositionTotal(_Symbol);
     double profit = AccountInfoDouble(ACCOUNT_PROFIT);
     if(posTotal==0 && isbuy!=0 && RSI800>90 && RSI200>90 && ma13M1<ma200 && ma13M1<ma50M1) {
         isbuy=0;
         SellPosition(Lot);
      }
       if(posTotal==0 && isbuy!=1 && RSI800<10 && RSI200<10 && ma13M1>ma200 && ma13M1>ma50M1) {
         isbuy=1;
         BuyPosition(Lot);
      }
       if(posTotal>0 && isbuy==0 && (RSI800<50 || RSI200<50)) {
      
         //BuyPosition(0.2);
         isbuy=2;
          close(_Symbol);
      }
      if(posTotal>0 && isbuy==1 && (RSI800>50 || RSI200>50)) {
         isbuy=2;
         //BuyPosition(0.2);
          close(_Symbol);
      }
